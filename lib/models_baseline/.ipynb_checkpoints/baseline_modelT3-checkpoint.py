...
class DNet(nn.Module):
    ...
    def forward(self, output_JC, msks_64, inp_guid, inp_Nd, masked_RN, Topo_Processed):
        ...
        x_In = torch.cat((output_JC, msks_64, inp_guid, inp_Nd, masked_RN, Topo_Processed), 1)

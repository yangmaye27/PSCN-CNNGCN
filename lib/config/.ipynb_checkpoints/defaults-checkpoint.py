...
_C.MODEL.EXTRA.STAGE1.NUM_BRANCHES = 2
_C.MODEL.EXTRA.STAGE1.NUM_BLOCKS = [4, 4]
_C.MODEL.EXTRA.STAGE1.NUM_CHANNELS = [64, 128]
_C.MODEL.EXTRA.STAGE1.BLOCK = 'BASIC'
...
_C.MODEL.EXTRA.STAGE3.NUM_BRANCHES = 2
_C.MODEL.EXTRA.STAGE3.NUM_BLOCKS = [4, 4]
_C.MODEL.EXTRA.STAGE3.NUM_CHANNELS = [64, 128]
